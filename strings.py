...
STRINGS = {
    'EN': {
        ...
        'BTN_BECOME_MEMBER': "Become Member ðŸš€",
        'REGISTRATION_MSG': (
            "ðŸŒŸ *Why join STEM?*\n\n"
            "â€¢ Official STEM Membership ID\n"
            "â€¢ Access to exclusive workshops & events\n"
            "â€¢ Networking with industry professionals\n"
            "â€¢ STEM Merchandise & goodies\n"
            "â€¢ Certificates of participation\n\n"
            "ðŸ‘‡ *Click the button below to register!*"
        ),
        'HELP_MSG': (
            "*About This Bot*\n\n"
            "This bot checks the STEM USAS membership database. It connects securely to the official records.\n\n"
            "*Check Membership* - Verify your membership status\n"
            "*Become Member* - Open membership registration form\n"
            "*Help* - View bot guide\n"
        ...
        'STATUS_PENDING': "*MEMBERSHIP PENDING* â³",
        'STATUS_REJECT': "*MEMBERSHIP REJECTED* ðŸš«",
        'NOTIFY_NEW_REG': "ðŸš¨ *New Registration*\n\nName: {name}\nMatric: {matric}\nResit: {resit}",
        'BTN_APPROVE': "Approve âœ…",
        'BTN_REJECT': "Reject ðŸš«",
        'MSG_APPROVED': "âœ… Approved {name}.",
        'MSG_REJECTED': "ðŸš« Rejected {name}.",
        ...
        'BTN_LANG_MS': "ðŸ‡²ðŸ‡¾ Bahasa Melayu",
        'MSG_LANG_CHANGED': "Language changed to English! ðŸ‡¬ðŸ‡§",
        'MSG_SELECT_LANG': "ðŸŒ *Select Language*",
        ...
        'BROADCAST_TITLE': "ðŸ“¢ *Admin Announcement*\n\n{msg}",
        ...
        'MSG_SA_ADDED': "âœ… *Admin added successfully!*",
        'MSG_SA_DELETED': "âœ… *Admin removed successfully!*",
        'ERR_SA_INVALID_ID': "âš ï¸ *Invalid ID format. Must be numeric.*",

        'ERR_SA_ALREADY_ADMIN': "âš ï¸ *User is already an Admin.*",
        'MSG_SA_PROMOTED': "ðŸŽ‰ *Congratulations! You have been promoted to Admin.*",
        ...
        'ADMIN_BROADCAST_DONE': "*Broadcast Complete* ðŸ“¢\n\nSuccess: *{success}*\nBlocked/Failed: *{failed}*",
    ...
    'MS': {
        'WELCOME_MSG': (
            ...
            "ðŸ‘‡ *Gunakan menu di bawah untuk mula.*"
        ),
        'BTN_BECOME_MEMBER': "Menjadi Ahli ðŸš€",
        'REGISTRATION_MSG': (
            "ðŸŒŸ *Kenapa sertai STEM?*\n\n"
            "â€¢ ID Keahlian STEM Rasmi\n"
            "â€¢ Akses ke bengkel & acara eksklusif\n"
            "â€¢ Rangkaian dengan profesional industri\n"
            "â€¢ Barangan & cenderahati STEM\n"
            "â€¢ Sijil penyertaan\n\n"
            "ðŸ‘‡ *Klik butang di bawah untuk mendaftar!*"
        ),
        'HELP_MSG': (
            "*Tentang Bot Ini*\n\n"
            "Perkhidmatan ini menyemak pangkalan data keahlian STEM USAS.\n"
            "Ia bersambung secara selamat ke rekod rasmi.\n\n"
            "*Semak Keahlian* - Sahkan status keahlian anda\n"
            "*Menjadi Ahli* - Buka borang pendaftaran keahlian\n"
            "*Info* - Lihat panduan bot\n"
            "*Tetapan* - Tukar bahasa\n\n"
            "Dev: *zis3c* ☺️"
        ),
        ...
        'STATUS_PENDING': "*KEAHLIAN SEDANG DIPROSES* â³",
        'STATUS_REJECT': "*KEAHLIAN DITOLAK* ðŸš«",
        'NOTIFY_NEW_REG': "ðŸš¨ *Pendaftaran Baru*\n\nNama: {name}\nMatrik: {matric}\nResit: {resit}",
        'BTN_APPROVE': "Luluskan âœ…",
        'BTN_REJECT': "Tolak ðŸš«",
        'MSG_APPROVED': "âœ… Diluluskan {name}.",
        'MSG_REJECTED': "ðŸš« Ditolak {name}.",
        ...
        'BTN_LANG_EN': "ðŸ‡¬ðŸ‡§ English",
        'BTN_LANG_MS': "ðŸ‡²ðŸ‡¾ Bahasa Melayu",
        'MSG_LANG_CHANGED': "Bahasa ditukar kepada Bahasa Melayu! ðŸ‡²ðŸ‡¾",
        'MSG_SELECT_LANG': "ðŸŒ *Pilih Bahasa*",
        ...
        'BROADCAST_TITLE': "ðŸ“¢ *Pengumuman Admin*\n\n{msg}",
        ...
        'BTN_ADMIN_CHECK_PENDING': "Semak Tertunda â³",
        ...
        'MSG_SA_ADDED': "âœ… Admin berjaya ditambah!",
        'MSG_SA_DELETED': "âœ… Admin berjaya dipadam!",
        'ERR_SA_INVALID_ID': "âš ï¸ Format ID tidak sah.",
        
        'ERR_SA_ALREADY_ADMIN': "âš ï¸ Pengguna ini sudah menjadi Admin.",
        'MSG_SA_PROMOTED': "ðŸŽ‰ Tahniah! Anda telah dilantik sebagai Admin.",
        ...
        'ADMIN_BROADCAST_DONE': "*Hebahan Selesai* ðŸ“¢\n\nâœ… Berjaya: {success}\nâŒ Gagal: {failed}",
